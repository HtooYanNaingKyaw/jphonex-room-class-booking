      ...
      <div className="space-y-6">
        <div className="bg-white shadow-lg rounded-xl border border-gray-100 p-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Rooms Management</h3>
            <p className="text-gray-500 mb-6">Comprehensive room management system coming soon...</p>
